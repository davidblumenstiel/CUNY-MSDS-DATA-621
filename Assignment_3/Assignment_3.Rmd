...
Has some variables that arent too predictive
...
88% accurate, highly significant, and auc = 0.966.  Pretty accurate.
...
predictions <- predict(glmnetmodel, newx = newx, type = "response", s="lambda.min") #setting lambda.min uses the lambda value with the minimum mean cv error (picks the best model)
